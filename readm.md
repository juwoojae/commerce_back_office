# 1. 프로젝트 개요
Spring Boot를 활용하여 전자상거래(E-commerce)의 핵심 운영 효율을 높이는 **관리자 페이지(백 오피스)**를 구축하고, 
이 과정에서 대용량 데이터 처리 및 안정적인 API 설계 역량을 입증하는 것을 목표로 합니다.
...
# 기술 스택 
- Spring Boot: 빠르고 안정적인 서버 구축 및 의존성 관리의 용이성을 위해 채택했습니다. 견고한 REST API 서버를 개발하는 데 중점을 두었습니다.
- JPA: 객체지향적인 데이터 관리 및 복잡한 쿼리 처리를 위한 핵심 ORM 기술로 채택했습니다. 트랜잭션 일관성 유지에 중점을 두었습니다.
