...
import static com.example.commerce_back_office.exception.code.SuccessCode.GET_REVIEW;
import static com.example.commerce_back_office.exception.code.SuccessCode.GET_REVIEWS;
...
public class AdminReviewController {
    ...
    @GetMapping
    public ResponseEntity<CommonResponse<List<ReviewResponseDto>>> getReviews(@RequestParam(required = false) String keyword) {
